...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-3L2BPCZ4.js").then(function(n4) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-PHZ5I6HN.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
  ...
  events({
    ...
    return includeDrafts && token && (esOptions.headers = {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" || esOptions.headers || esOptions.withCredentials ? (await import("./browser-PHZ5I6HN.js")).default : EventSource;
        if (unsubscribed)
          return;
        try {
          if (await fetch(url, {
